...
class ConstantColor {
 ...
 // static MaterialColor materialPrimaryColor = MaterialColor(0xFFff003e, color);
  static MaterialColor materialPrimaryColor = MaterialColor(0xFFffffff, color);
  static MaterialColor materialPrimaryColorDark = MaterialColor(0xFFC8161D, color);
  ...
  static Color red = Color(0xFFC8161D);
